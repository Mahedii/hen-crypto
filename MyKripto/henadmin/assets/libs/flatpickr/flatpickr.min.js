/* flatpickr v4.6.13,, @license MIT */ ! function(e, n) {
	...
	var t = ["onChange", "onClose", "onDayCreate", "onDestroy", "onKeyDown", "onMonthChange", "onOpen", "onParseConfig", "onReady", "onValueUpdate", "onYearChange", "onPreCalendarPosition"],
		...
		i = {
			weekdays: {
				shorthand: ["Son", "Maa", "Din", "Woe", "Dno", "Vry", "Sat"],
				longhand: ["Sondag", "Maandag", "Dinsdag", "Woensdag", "Donderdag", "Vrydag", "Saterdag"]
			},
			months: {
				shorthand: ["Jan", "Feb", "Mrt", "Apr", "Mei", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Des"],
				longhand: ["Januarie", "Februarie", "Maart", "April", "Mei", "Junie", "Julie", "Augustus", "September", "Oktober", "November", "Desember"]
			},
