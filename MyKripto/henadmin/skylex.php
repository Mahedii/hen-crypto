...
<?php
	...
	if (isset($_POST['submit'])) 
	{
        ...
        header("location: skylex.php?mes=2");
	}
...
<link href="./assets/css/skylex.css" rel="stylesheet" />
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
								...
								<div class="card-body">
									<form action="skylex.php" method="post" name="testform" enctype="multipart/form-data">
												<label>Een</label>
													<input type="text" name="EEN" title="Een" value="<?php echo $EEN; ?>" required />
												<label>Twee</label>
													<input type="text" name="TWEE" title="Twee" value="<?php echo $TWEE; ?>" required />
												<label>Drie</label>
													<input type="text" name="DRIE" title="Drie" value="<?php echo $DRIE; ?>" required />
												<label>VIER</label>
													<input type="text" name="VIER" title="Vier" value="<?php echo $VIER; ?>" required />
												<label>VYF</label>
													<input type="text" name="VYF" title="Vyf" value="<?php echo $VYF; ?>" required />
												<label>SES</label>
													<input type="text" name="SES" title="Ses" value="<?php echo $SES; ?>" required />
												<label>SEWE</label>
													<input type="text" name="SEWE"  title="Sewe" value="<?php echo $SEWE; ?>" required />
												<label>AGT</label>
													<input type="text" name="AGT" title="Agt" value="<?php echo $AGT; ?>" required />	
														<div class="col-sm-9 col-sm-offset-3">
															<button class="btn btn-danger" style="height:50px;width:100px;font-size:20px;" name="submit" >Dien in</button>
															<button type="reset" style="height:50px;width:100px;font-size:20px;" class="btn btn-dark">Herstel</button>
												</div>
									</form>
								</div>
                        </div>
