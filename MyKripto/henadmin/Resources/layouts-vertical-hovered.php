...
<html lang="en" data-layout="vertical" data-layout-style="default" data-layout-position="fixed" data-topbar="light" data-sidebar="dark" data-sidebar-size="sm-hover" data-layout-width="fluid">
    ...
    <head>
        ...
        <title>Vertical Hovered Layout | Velzon - Admin & Dashboard Template</title>
                        ...
                        <div class="col-xxl-3">
                            <div class="card card-height-100">
                                <div class="card-header border-0 align-items-center d-flex">
                                    ...
                                    <div>
                                        <div class="dropdown">
                                            <button class="btn btn-soft-primary btn-sm shadow-none"
                                    ...
                                    <ul class="list-group list-group-flush border-dashed mb-0 mt-3 pt-2">
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-xs">
                                                    <span class="avatar-title bg-light p-1 rounded-circle shadow">
                                                        <img src="assets/images/svg/crypto-icons/eth.svg"
                                                            class="img-fluid" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img src="assets/images/svg/crypto-icons/bnb.svg"
                                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid shadow"
                                                        alt="">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img src="assets/images/svg/crypto-icons/usdt.svg"
                                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid shadow"
                                                        alt="">
                            ...
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    ...
                                    <div class="flex-shrink-0">
                                        <button class="btn btn-soft-primary btn-sm shadow-none">24H</button>
                                    </div>
                                    <div class="flex-shrink-0 ms-2">
                                        <div class="dropdown card-header-dropdown">
                                            <a class="btn btn-soft-primary btn-sm shadow-none" role="button" href="#"
                                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>$53,914.025</td>
                                                    <td>1.25634801</td>
                                                    <td><a href="apps-crypto-buy-sell.php"
                                                            class="btn btn-sm btn-soft-secondary shadow-none">Trade</a>
                                                    </td>
                                                </tr><!-- end -->
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="assets/images/svg/crypto-icons/doge.svg"
                                                                    alt="" class="avatar-xxs shadow rounded-circle">
                                                            </div>
                                                            <div>
                                        ...
                                        <div class="p-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-xs flex-shrink-0">
                                                    <span class="avatar-title bg-light rounded-circle shadow">
                                ...
                                <div class="card-body p-0">
                                    <ul class="list-group list-group-flush border-dashed mb-0">
                                        <li class="list-group-item d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/svg/crypto-icons/btc.svg"
                                                    class="avatar-xs shadow rounded-circle" alt="">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                        ...
                                        <li class="list-group-item d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/svg/crypto-icons/aave.svg"
                                                    class="avatar-xs shadow rounded-circle" alt="">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-middle">
                                        <div class="flex-shrink-0">
                                            <img src="assets/images/small/img-1.jpg" class="rounded img-fluid shadow"
                                    ...
                                    <div class="d-flex mt-4">
                                        <div class="flex-shrink-0">
                                            <img src="assets/images/small/img-2.jpg" class="rounded img-fluid shadow"
                                                style="height: 60px;" alt="">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex mt-4">
                                        <div class="flex-shrink-0">
                                            <img src="assets/images/small/img-3.jpg" class="rounded img-fluid shadow"
                                                style="height: 60px;" alt="">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex mt-4">
                                        <div class="flex-shrink-0">
                                            <img src="assets/images/small/img-6.jpg" class="rounded img-fluid shadow"
                                                style="height: 60px;" alt="">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
