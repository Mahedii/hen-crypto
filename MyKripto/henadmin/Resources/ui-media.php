...
<?php include 'layouts/head-main.php'; ?>
    ...
    <head>
        ...
        <title>Media Object | Velzon - Admin & Dashboard Template</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Media Object</h4>
                                        ...
                                        <div class="live-preview">
                                            <div class="d-flex align-items-start text-muted mb-4">
                                                <div class="flex-shrink-0 me-3">
                                                    <img src="assets/images/users/avatar-2.jpg" class="avatar-sm rounded shadow" alt="...">
                                                </div>
                                            ...
                                            <div class="d-flex align-items-start text-muted mb-4">
                                                ...
                                                <div class="flex-shrink-0 ms-3">
                                                    <img src="assets/images/users/avatar-3.jpg" class="avatar-sm rounded shadow" alt="...">
                                                </div>
                                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="live-preview">
                                            ...
                                            <div class="d-flex align-items-start text-muted">
                                                <div class="flex-shrink-0 me-3">
                                                    <img src="assets/images/users/avatar-4.jpg" class="avatar-sm rounded shadow" alt="...">
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h5 class="fs-14">Media heading</h5>
                                                    This is some content from a media component. You can replace this with any content and adjust it as needed.
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="live-preview">
                                            ...
                                            <div class="d-flex align-items-center text-muted mb-4">
                                                <div class="flex-shrink-0 me-3">
                                                    <img src="assets/images/users/avatar-6.jpg" class="avatar-sm rounded shadow" alt="...">
                                                </div>
                                            ...
                                            <div class="d-flex align-items-end text-muted">
                                                <div class="flex-shrink-0 me-3">
                                                    <img src="assets/images/users/avatar-8.jpg" class="avatar-sm rounded shadow" alt="...">
                                                </div>
