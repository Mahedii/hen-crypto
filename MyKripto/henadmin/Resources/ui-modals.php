...
<?php include 'layouts/head-main.php'; ?>
    ...
    <head>
        ...
        <title>Modals | Velzon - Admin & Dashboard Template</title>
                                            ...
                                            <div class="modal fade" id="exampleModalPopovers" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <div class="mx-auto">
                                                                <a href="javascript:void(0);" class="btn btn-link fw-medium shadow-none">Read More <i class="ri-arrow-right-line ms-1 align-middle"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <form>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="mt-1 text-end">
                                                                    <a href="auth-pass-reset-basic.php">Forgot password ?</a>
                                                                </div>
                                                            </div>
