                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4 mb-3">
                        <div class="col-sm-auto">
                            <div>
                                <a href="apps-projects-create.php" class="btn btn-success"><i
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item"
                                                                href="apps-projects-overview.php"><i
                                                                    class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                                View</a>
                                                            <a class="dropdown-item" href="apps-projects-create.php"><i
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="d-flex gap-1 align-items-center">
                                                    <button type="button"
                                                        class="btn avatar-xs mt-n1 p-0 favourite-btn shadow-none active">
                                                        <span class="avatar-title bg-transparent fs-15">
                                                            <i class="ri-star-fill"></i>
                                                        </span>
                                                    </button>
                                            ...
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar-sm">
                                                    <span class="avatar-title bg-soft-info rounded p-2">
                                                        <img src="assets/images/brands/dropbox.png" alt=""
                                                            class="img-fluid p-1">
                                                    </span>
                                                </div>
                                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-soft-danger rounded-top">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h5 class="mb-0 fs-14"><a href="apps-projects-overview.php"
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="d-flex gap-1 align-items-center my-n2">
                                                    ...
                                                    <div class="dropdown">
                                                        <button
                                                            class="btn btn-link text-muted p-1 mt-n1 py-0 text-decoration-none fs-15 shadow-none"
                                                            data-bs-toggle="dropdown" aria-haspopup="true"
                                                            aria-expanded="true">
                                                            <i data-feather="more-horizontal" class="icon-sm"></i>
                                                        </button>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-soft-info rounded-top">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="d-flex gap-1 align-items-center my-n2">
                                                    <button type="button"
                                                        class="btn avatar-xs p-0 favourite-btn shadow-none">
                                                        <span class="avatar-title bg-transparent fs-15">
                                                            <i class="ri-star-fill"></i>
                                                        </span>
                                                    </button>
                                    ...
                                    <div>
                                        ...
                                        <div class="progress progress-sm animated-progress bg-soft-success">
                                            <div class="progress-bar bg-success" role="progressbar" aria-valuenow="41"
                        ...
                        <div class="col-xxl-3 col-sm-6 project-card">
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-soft-secondary rounded-top">
                                        <div class="d-flex gap-1 align-items-center justify-content-end my-n2">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="apps-projects-overview.php"><i
                                                            class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                        View</a>
                                                    <a class="dropdown-item" href="apps-projects-create.php"><i
                                                            class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                    ...
                                    <div class="py-3">
                                        <h5 class="fs-14 mb-3"><a href="apps-projects-overview.php"
                                                class="text-dark">Kanban Board</a></h5>
                                        <div class="row gy-3">
                                            <div class="col-6">
                                                <div>
                                                    <p class="text-muted mb-1">Status</p>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-light rounded-top">
                                        <div class="d-flex gap-1 align-items-center justify-content-end my-n2">
                                            <button type="button" class="btn avatar-xs p-0 favourite-btn shadow-none">
                                                <span class="avatar-title bg-transparent fs-15">
                                                    <i class="ri-star-fill"></i>
                                                </span>
                                            </button>
                                    ...
                                    <div class="py-3">
                                        <h5 class="mb-3 fs-14"><a href="apps-projects-overview.php"
                                                class="text-dark">Ecommerce app</a></h5>
                                        <div class="row gy-3">
                                            <div class="col-6">
                                                <div>
                                                    <p class="text-muted mb-1">Status</p>
