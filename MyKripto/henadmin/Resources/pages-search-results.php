...
<?php include 'layouts/head-main.php'; ?>
    ...
    <head>
        ...
        <title>Search Results | Velzon - Admin & Dashboard Template</title>
                                                ...
                                                <div class="row g-2">
                                                    <div class="col">
                                                        <div class="position-relative mb-3">
                                                            ...
                                                            <a class="btn btn-link link-success btn-lg position-absolute end-0 top-0 shadow-none" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample"><i class="ri-mic-fill"></i></a>
                                                        </div>
                                                    </div>
                                                    <div class="col-auto">
                                        ...
                                        <div class="tab-content text-muted">
                                            <div class="tab-pane active" id="all" role="tabpanel">
                                                <div class="pb-3">
                                                    ...
                                                    <p class="text-success mb-2">https://themesbrand.com/velzon/index.php</p>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 video-list">
                                                        <div class="list-element">
                                                            ...
                                                            <p class="text-success">https://themesbrand.com/velzon/index.php</p>
