                                ...
                                <div class="row justify-content-center g-0">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-lg-5 p-4">
                                            ...
                                            <div class="p-2">
                                                <form action="auth-signin-basic.php">
                                                    <div class="mb-3">
                                            ...
                                            <div class="mt-5 text-center">
                                                <p class="mb-0">Wait, I remember my password... <a href="auth-signin-cover.php" class="fw-semibold text-primary text-decoration-underline"> Click here </a> </p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end col -->
