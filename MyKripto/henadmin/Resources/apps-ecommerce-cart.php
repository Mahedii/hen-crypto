...
<?php include 'layouts/head-main.php'; ?>
    ...
    <head>
        ...
        <title>Shopping Cart | Velzon - Admin & Dashboard Template</title>
                                ...
                                <div class="card product">
                                    <div class="card-body">
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-sm">
                                                <h5 class="fs-14 text-truncate"><a href="ecommerce-product-detail.php"
                                    ...
                                    <div class="alert border-dashed alert-danger" role="alert">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-2">
                                                ...
                                                <button type="button"
                                                    class="btn ps-0 btn-sm btn-link text-danger text-uppercase shadow-none">Add
                                                    Gift Wrap</button>
                                            </div>
                                        </div>
                                    </div>
