                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Beskikbare munte lys</h5>
                            </div>
                            <div class="card-body">
                                <table id="example"
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $result = mysqli_query($pdo, " SELECT * FROM nmc_munt_lys ORDER BY ID ASC ");
                                            ...
                                            do { ?> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row["COIN_LOGO"]; ?></td>
                                                    <td><img src="<?php echo $row["COIN_LOGO"]; ?>" alt="<?php echo $row["COIN_NAME"]; ?>" width="32px"></td>
